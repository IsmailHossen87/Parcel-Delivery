...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashePassword = yield bcryptjs_1.default.hash(password, Number(env_1.envVar.BCRYPT_SALT_ROUND));
    const authProvider = { provider: "credentials", providerId: email };
    const user = yield user_model_1.User.create(Object.assign({ email, password: hashePassword, auths: [authProvider] }, rest));
    return user;
});
// Update User
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.role && decodedToken.role !== user_interface_1.UserRole.admin) {
        throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "Only admin can update the role");
    }
    // finally update User
...
exports.userService = { createUser, updateUser, getSingleUser };
