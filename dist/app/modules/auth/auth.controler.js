...
const credentialsLogin = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    passport_1.default.authenticate("local", (err, user, info) => __awaiter(void 0, void 0, void 0, function* () {
        if (err) {
            return next(new AppError_1.default(500, err.message || "Internal Server Error"));
        }
        if (!user) {
...
const changePassword = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const changePass = yield auth_service_1.AuthService.changePassword(newPassword, oldPassword, decodedToken);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
...
const setPassword = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield auth_service_1.AuthService.setPassword(decodedToken.user_ID, password);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
...
// Passprot
const googleCallbackContoller = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = (0, user_Token_1.createUserToken)(user);
    (0, setCookie_1.setAuthCookies)(res, token);
    res.redirect(`${env_1.envVar.FRONTEND_URL}/${redirectTo}`);
}));
exports.AuthControler = { credentialsLogin, getNewAccessToken, logOut, setPassword, changePassword, googleCallbackContoller };
