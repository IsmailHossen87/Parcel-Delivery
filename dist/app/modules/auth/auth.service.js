...
const credentialsLogin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userToken = (0, user_Token_1.createUserToken)(isUserExist);
...
const getNewAccessToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const newGenerateToken = yield (0, user_Token_1.createNewAccessTokenWithRefresh)(refreshToken); //link utils/userToken
    return {
...
const changePassword = (newPassword, oldPassword, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.findById(decodedToken.user_ID);
...
const setPassword = (userId, plainPass) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcryptjs_1.default.hash(plainPass, Number(env_1.envVar.BCRYPT_SALT_ROUND));
...
exports.AuthService = { credentialsLogin, getNewAccessToken, changePassword, setPassword };
